...
badd +1 store/sagas/countries.saga.ts
...
badd +38 components/header/Search.tsx
badd +1 components/header/DropMobile.tsx
...
badd +46 components/FilterItem.tsx
badd +1 lib/ChangeRoute.ts
badd +18 components/Loader.tsx
argglobal
%argdel
tabnew
tabnew
...
balt store/sagas/countries.saga.ts
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
exe 'vert 2resize ' . ((&columns * 55 + 75) / 151)
tabnext
edit components/header/Search.tsx
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
silent! normal! zE
let &fdl = &fdl
let s:l = 36 - ((20 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 36
...
wincmd w
argglobal
if bufexists("components/Header.tsx") | buffer components/Header.tsx | else | edit components/Header.tsx | endif
if &buftype ==# 'terminal'
  silent file components/Header.tsx
endif
balt components/header/DropMobile.tsx
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
normal! zt
keepjumps 21
let s:c = 40 - ((38 * winwidth(0) + 27) / 55)
if s:c > 0
